...
export default {
    ...
    data() {
        return {
            imgUrl: '',
            hatLists: [hat1, hat2, hat3, hat4, hat5],
            sPosition: {
                x: 0,
                y: 0
            },
    ...
    methods: {
        ...
        moveHat(e) {
            ...
            moveDom.style.transform = `translateX(${this.dX + this.moveX}px) translateY(${this.dY + this.moveY}px) scale(${this.scale}) rotate(${
                this.rotate
            }deg)`
            moveDom.style.webkitTransform = `translateX(${this.dX + this.moveX}px) translateY(${this.dY + this.moveY}px) scale(${
                this.scale
        ...
        moveBar(e) {
            ...
            this.scale =
                Math.sqrt(Math.pow(e.touches[0].clientX - this.centerX, 2) + Math.pow(e.touches[0].clientY - this.centerY, 2)) /
                (Math.sqrt(2) * 50)
            ...
            moveDom.style.transform = `translateX(${this.dX}px) translateY(${this.dY}px) scale(${this.scale}) rotate(${this.rotate}deg)`
            moveDom.style.webkitTransform = `translateX(${this.dX}px) translateY(${this.dY}px) scale(${this.scale}) rotate(${this.rotate}deg)`
        ...
        selectHat(hat) {
            ...
            let delDom = document.querySelector('.del')
            setTimeout(function () {
                self.centerY = (delDom.getBoundingClientRect().top + moveDom.getBoundingClientRect().top + 10) / 2
                self.centerX = (delDom.getBoundingClientRect().left + moveDom.getBoundingClientRect().left + 10) / 2
